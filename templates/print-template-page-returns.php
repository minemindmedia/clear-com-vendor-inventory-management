                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="7" class="p-4 border-l-8 border-b-2 border-gray-300">
                            <div class="block"><span class="font-bold text-sm">Cancellation Note:</span> <?php echo $singleLineItem->product_quantity_canceled_note; ?></div>
                            <div class="block"><span class="font-bold text-sm">Return Note:</span> <?php echo $singleLineItem->product_quantity_returned_note; ?></div>
                        </td>
                    </tr>
                    <?php 
                    }
