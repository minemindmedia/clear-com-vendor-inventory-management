...
?>
    ...
    <div class="flex flex-col divide-y-2 divide-gray-300 divide-solid w-full mx-auto">
        ...
        <table class="table w-full py-8">
            <thead>
                <tr class="text-left">
                    <th class="p-2 border-b border-gray-500 font-bold text-sm">QTY:</th>
                    <th class="p-2 border-b border-gray-500 font-bold text-sm">Vendor SKU:</th>
                    <th class="p-2 border-b border-gray-500 font-bold text-sm">CC SKU:</th>
                    <th class="p-2 border-b border-gray-500 font-bold text-sm">Details:</th>
                    <th class="p-2 border-b border-gray-500 font-bold text-sm">Price:</th>
                    <th class="p-2 border-b border-gray-500 font-bold text-sm">Total:</th>
                </tr>
            </thead>
            <?php
            $itemQty = '';
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="table-cell"></td>
                    <td class="table-cell"></td>
                    <td class="p-2 border-b border-l border-gray-300 font-bold text-sm">
                        Grand Total:
                    </td>
                    <td class="p-2 border-b border-gray-300 aligh-right text-sm">
